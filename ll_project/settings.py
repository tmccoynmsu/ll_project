...
SECRET_KEY = 'django-insecure-placeholder-key'  # default for local
...
if Config:
    ...
    if config.is_valid_platform():
        ...
        # SECRET_KEY from Platform.sh entropy
        ...
        if not config.in_build():
            ...
            # Build phase: use SQLite temporarily
            DATABASES = {
                'default': {
        ...
        # Not on Platform.sh, use local SQLite
        DATABASES = {
            'default': {
                'ENGINE': 'django.db.backends.sqlite3',
                'NAME': BASE_DIR / 'db.sqlite3',
